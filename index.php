  ...
  <body>
    ...
    <article class="parallax_container">
      <div
        class="car"
        id="car"
        style="background-image: url('./image/kaif/desert-bg.jpg')"
      >
        <div class="gradient"></div>
        <img
          class="car__rolls"
          id="car__rolls"
          src="image/kaif/car_rolls.png"
          alt=""
        />
        <div class="bg-home">
          ...
          <header>
            <div class="container">
              <div class="header__inner">
                <img src="image/logo.svg" class="logo__pc" alt="" />
      ...
      >
        <div class="bg-home">
          ...
          <div class="mobile-img">
            <img src="./image/kaif/car_mobile.png" alt="" />
          </div>
          <div class="container">
            <div class="main__btn">
              <a href="#cars" class="hide-parallax">посмотреть автопарк</a>
      ...
      <div class="container">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides3(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides3(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/bentayga/1.png"
                      style="width: 100%"
                      onclick="currentSlide3(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/bentayga/2.png"
                      style="width: 100%"
                      onclick="currentSlide3(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/bentayga/3.png"
                      style="width: 100%"
                      onclick="currentSlide3(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides4(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides4(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/f8/1.png"
                      style="width: 100%"
                      onclick="currentSlide4(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/f8/2.png"
                      style="width: 100%"
                      onclick="currentSlide4(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/f8/3.png"
                      style="width: 100%"
                      onclick="currentSlide4(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides5(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides5(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/portofino/1.png"
                      style="width: 100%"
                      onclick="currentSlide5(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/portofino/2.png"
                      style="width: 100%"
                      onclick="currentSlide5(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/portofino/3.png"
                      style="width: 100%"
                      onclick="currentSlide5(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides6(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides6(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/urus/1.png"
                      style="width: 100%"
                      onclick="currentSlide6(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/urus/2.png"
                      style="width: 100%"
                      onclick="currentSlide6(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/urus/3.png"
                      style="width: 100%"
                      onclick="currentSlide6(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides7(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides7(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan1/1.png"
                      style="width: 100%"
                      onclick="currentSlide7(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan1/2.png"
                      style="width: 100%"
                      onclick="currentSlide7(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan1/3.png"
                      style="width: 100%"
                      onclick="currentSlide7(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides8(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides8(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan2/1.png"
                      style="width: 100%"
                      onclick="currentSlide8(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan2/2.png"
                      style="width: 100%"
                      onclick="currentSlide8(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/huracan2/3.png"
                      style="width: 100%"
                      onclick="currentSlide8(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides9(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides9(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/g63/1.png"
                      style="width: 100%"
                      onclick="currentSlide9(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/g63/2.png"
                      style="width: 100%"
                      onclick="currentSlide9(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/g63/3.png"
                      style="width: 100%"
                      onclick="currentSlide9(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides10(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides10(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/911/1.png"
                      style="width: 100%"
                      onclick="currentSlide10(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/911/2.png"
                      style="width: 100%"
                      onclick="currentSlide10(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/911/3.png"
                      style="width: 100%"
                      onclick="currentSlide10(3)"
                    />
                  </div>
                </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="container_">
                ...
                <a class="prev" onclick="plusSlides11(-1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <a class="next" onclick="plusSlides11(1)"
                  ><img src="./image/left-arrow.png"
                /></a>
                <div class="caption-container">
                  <p id="caption"></p>
                ...
                <div class="row">
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/718/1.png"
                      style="width: 100%"
                      onclick="currentSlide11(1)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/718/2.png"
                      style="width: 100%"
                      onclick="currentSlide11(2)"
                    />
                  </div>
                  <div class="column">
                    <img
                      class="demo cursor"
                      src="image/cars/718/3.png"
                      style="width: 100%"
                      onclick="currentSlide11(3)"
                    />
                  </div>
                </div>
              </div>
        ...
        <div class="cars__inner">
          <div class="cars__item" id="item1">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-transformed.png"
                alt=""
              />
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Хотите путешествовать в роскошных условиях, но при этом в
                  автомобиле вам важна практичность, функциональность и
                  проходимость? Тогда выбирайте Rolls Royce Cullinan. <br />
                  Это автомобиль с внушительными размерами, классическим
                  эффектным дизайном и характеристиками внедорожника с роскошным
                  салоном, который сочетает в себе передовые технологии и
                  традиционный английский стиль. Комфорт и эстетика вам
                  обеспечены.<br />
                  С Rolls Royce Cullinan вы можете сделать перерыв на пикник в
                  любом месте. Багажник с двухстворчатой дверью оснащен
                  выдвигающейся банкеткой с двумя стульями и столиком. Ваш отдых
                  будет комфортным и романтичным.
                </p>
              </div>
          ...
          <div class="cars__item" id="item2">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-FW-DAloFK-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Если вы являетесь приверженцем утонченного стиля и
                  элегантности, то вам понравится путешествовать в кабриолете
                  Rolls Royce Dawn. Каждая поездка на нем дарит неповторимые
                  эмоции от комфорта, функциональности и английской эстетики.
                  <br />
                  Он отлично подчеркнет ваш статус. <br />
                  Всего 22 секунды нужно, чтобы открыть салон и насладиться
                  приятным бризом на дорогах Дубая. Так быстро складывается
                  откидная крыша Rolls Royce Dawn. Но даже с открытым верхом вы
                  будете чувствовать себя максимально комфортно за счет хорошей
                  шумоизоляции.<br />
                  Любителям скорости понравится стабильность автомобиля на
                  дороге.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
          ...
          <div class="cars__item" id="item3">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(1)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Получите совершенно новый опыт езды на автомобиле с
                  улучшенными внедорожными характеристиками. Он оснащен мощным
                  двигателем и способен развивать высокую скорость, сохраняя
                  устойчивость, маневренность и управляемость. <br />
                  Bentley Bentayga - поистине роскошный внедорожник, который
                  задает новые стандарты комфорта. <br />
                  Пространство внутри Bentley Bentayga продумано до мелочей. А
                  набор технологичных и интуитивно понятных решений позволяет
                  чувствовать себя уверенно и непринужденно в любых дорожных
                  условиях. Это особенно актуально при путешествиях в незнакомом
                  городе. <br />
                  Bentley Bentayga - это роскошь, мощность и динамика в одном
                  лице.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
          ...
          <div class="cars__item" id="item4">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(2)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Выбор для самых искушенных гонщиков. Самый мощный и быстрый
                  автомобиль в семействе Ferrari. Трижды обладатель награды
                  “Лучший двигатель года”. <br />
                  Этот спорткар порадует вас не только своими скоростными
                  качествами, но и продуманными системами помощи при торможении,
                  разгоне, заносах. Благодаря ним вы будете уверенно чувствовать
                  себя, даже если никогда не сидели за рулем спорткара.<br />
                  Классический узнаваемый дизайн Ferrari выделит вас на дороге.
                  <br />
                  Почувствуйте легкость управления, мощь и азарт скорости вместе
                  с Ferrari F8.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
          ...
          <div class="cars__item" id="item5">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(3)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Автомобиль класса Gran Turismo не оставит равнодушными
                  ценителей скорости, комфорта и функциональности. <br />
                  Ferrari Portofino - самый мощный открытый автомобиль в
                  модельном ряде Ferrari. Его назвали в честь одной из деревушек
                  в Италии. Он подходит как для повседневных поездок, так и для
                  легких живописных прогулок, которыми вы можете насладиться
                  откинув верх.<br />
                  Внушительный объем багажного отделения позволит вам совершать
                  длительные поездки, имея при себе все необходимое. При этом
                  чувствовать легкость и комфорт в просторном салоне.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
          ...
          <div class="cars__item" id="item6">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(4)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  С Lamborghini Urus вы сможете покорить любые маршруты. Это
                  первый в мире спортивный кроссовер, который обладает всеми
                  преимуществами внедорожника и скоростного автомобиля. <br />
                  Если вам нужен универсальный автомобиль, то это точно будет
                  Lamborghini Urus.<br />
                  Роскошный итальянский дизайн не оставит равнодушными самых
                  отъявленных ценителей стиля и красоты. <br />
                  Максимальный комфорт в процессе вождения достигается
                  оснащением Lamborghini Urus высокотехнологичными опциями. Вам
                  будет легко и приятно за рулем этого автомобиля.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
          ...
          <div class="cars__item" id="item7">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(5)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Хотите испытать ощущение превосходства на дороге? Lamborghini
                  Huracan с роскошным итальянским дизайном покоряет с первого
                  взгляда. <br />
                  Это первый в мире технлологичный спорткар, который использует
                  систему автономной интернациональной навигации. Благодаря
                  этому он обладает высоким уровнем управляемости.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
          ...
          <div class="cars__item" id="item8">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/23456345634563456345634563.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
          ...
          <div class="cars__item" id="item9">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(6)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Легендарный спортивный внедорожник. Он подходит как для
                  путешествий по самым неожиданным маршрутам, так и для
                  скоростных приключений на трассах. <br />
                  Mercedes G63 оснащен мощным двигателем V8 двойным
                  турбонаддувом. <br />
                  Неповторимый дизайн Mercedes G63 с внушительной решеткой
                  радиатора понравится ценителям мощности и надежности. <br />
                  На любой дороге вы будете чувствовать себя комфортно в
                  просторном салоне. Обивка сидений выполнена из кожи и имеет
                  уникальный для Mercedes ромбовидный дизайн. А все остальные
                  элементы салона выполнены из современных технологичных
                  материалов (карбон, микроволокно).
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
          ...
          <div class="cars__item" id="item10">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-1-(7)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Porsche 911 - спортивный премиальный автомобиль с длинной
                  историей. <br />
                  Он производится с 1963, регулярно обновляясь и не теряя своей
                  популярности. <br />
                  Комфорт, безопасность и технологичность - так можно
                  охарактеризовать Porsche 911. <br />
                  Несмотря на небольшие габариты, в салоне вам будет просторно и
                  удобно. А наличие систем помощи водителю и других передовых
                  технологий сделает ваши поездки безопасными и подарит
                  незабываемые эмоции от вождения.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
          ...
          <div class="cars__item" id="item11">
            <div class="cars__item__top">
              ...
              <img
                class="item__image"
                src="image/cars/Rolls-Royce-Cullinan-2-(8)-transformed.png"
                alt=""
              />
              <div class="item__back">
                <div class="item__price">
            ...
            >
              ...
              <div class="cars__text">
                <p>
                  Forwarded message <br />
                  Тот самый<br />
                  Спортивный автомобиль с невероятно стильным дизайном. Он
                  оснащен специальными адаптивными амортизаторами, чтобы вы
                  чувствовали себя комфортно и в повседневных поездках. <br />
                  Porsche Cayman 718 идеально подходит для коротких и длинных
                  путешествий. Просторный салон с удобными спортивными
                  сиденьями, много места для мелких вещей и два багажных
                  отделения. <br />
                  Для удобства вождения и безопасности на дорогах Porsche Cayman
                  718 оснащен современной техникой. Вы сможете насладиться
                  скоростью спорткара в сочетании с комфортом и безопасностью.
                </p>
              </div>
              <h3 class="specifications__logo">технические характеристики</h3>
              <table class="cars__specifications">
        ...
        <div class="swiper" style="overflow: unset">
          <div class="cars__inner__mobile">
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Хотите путешествовать в роскошных условиях, но при этом в
                    автомобиле вам важна практичность, функциональность и
                    проходимость? Тогда выбирайте Rolls Royce Cullinan. Это
                    автомобиль с внушительными размерами, классическим эффектным
                    дизайном и характеристиками внедорожника с роскошным
                    салоном,
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
            ...
            <div
              class="cars__item swiper-slide"
              style="max-width: 330.09px; margin-left: 10px"
            >
              <div class="cars__item__top">
                <h3 class="item__name">Rolls Royce Dawn</h3>
                <img
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    ...
                    Rolls Royce Dawn. Каждая поездка на нем дарит неповторимые
                    эмоции от комфорта, функциональности и английской эстетики.
                    Он отлично подчеркнет ваш статус. Всего 22 секунды нужно,
                    чтобы открыть салон и насладиться приятным бризом на дорогах
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
                <table class="cars__specifications">
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    ...
                    улучшенными внедорожными характеристиками. Он оснащен мощным
                    двигателем и способен развивать высокую скорость, сохраняя
                    устойчивость, маневренность и управляемость. Bentley
                    Bentayga - поистине роскошный внедорожник, который задает
                    новые
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Выбор для самых искушенных гонщиков. Самый мощный и быстрый
                    автомобиль в семействе Ferrari. Трижды обладатель награды
                    “Лучший двигатель года”. Этот спорткар порадует вас не
                    только своими скоростными качествами, но и продуманными
                    системами помощи при торможении, разгоне, заносах. Благодаря
                    ним вы будете уверенно чувствовать себя,
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
                <table class="cars__specifications">
            ...
            >
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Автомобиль класса Gran Turismo не оставит равнодушными
                    ценителей скорости, комфорта и функциональности. Ferrari
                    Portofino - самый мощный открытый автомобиль в модельном
                    ряде Ferrari. Его назвали в честь одной из деревушек в
                    Италии. Он подходит как для повседневных поездок, так и для
                    легких живописных
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    С Lamborghini Urus вы сможете покорить любые маршруты. Это
                    первый в мире спортивный кроссовер, который обладает всеми
                    преимуществами внедорожника и скоростного автомобиля. Если
                    вам нужен универсальный автомобиль, то это точно будет
                    Lamborghini Urus.<br />
            ...
            >
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Хотите испытать ощущение превосходства на дороге?
                    Lamborghini Huracan с роскошным итальянским дизайном
                    покоряет с первого взгляда.<br />
                    Это первый в мире технлологичный спорткар, который
                    использует систему автономной интернациональной навигации.
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Легендарный спортивный внедорожник. Он подходит как для
                    путешествий по самым неожиданным маршрутам, так и для
                    скоростных приключений на трассах. Mercedes G63 оснащен
                    мощным двигателем V8 двойным турбонаддувом. Неповторимый
                    дизайн Mercedes G63 с внушительной решеткой радиатора
                    понравится ценителям мощности и
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
                <table class="cars__specifications">
            ...
            >
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Porsche 911 - спортивный премиальный автомобиль с длинной
                    историей. Он производится с 1963, регулярно обновляясь и не
                    теряя своей популярности. Комфорт, безопасность и
                    технологичность - так можно охарактеризовать Porsche 911.
                    Несмотря на небольшие габариты, в салоне вам будет просторно
                    и удобно. А наличие систем помощи водителю и других
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
                <table class="cars__specifications">
              ...
              >
                ...
                <div class="cars__text">
                  <p>
                    Спортивный автомобиль с невероятно стильным дизайном. Он
                    оснащен специальными адаптивными амортизаторами, чтобы вы
                    чувствовали себя комфортно и в повседневных поездках.
                    Porsche Cayman 718 идеально подходит для коротких и длинных
                    путешествий. Просторный салон с удобными
                  </p>
                </div>
                <h3 class="specifications__logo">технические характеристики</h3>
                <table class="cars__specifications">
    ...
    <div class="calc" id="calc">
      <img
        ...
        src="image/effect/effect_sand_right.png"
        alt=""
      />
      <div class="container">
        ...
        <div class="calc__inner">
          <div class="calc__cars">
            ...
            <img
              ...
              src="image/form/Rolls-Royce-Cullinan-1-transformed.png"
              alt=""
            />
            <div class="calc__select">
              ...
              <select id="cars_picker" onchange="calculateCost()">
                ...
                <option value="Lamborghini Huracan 2022">
                  Lamborghini Huracan 2022
                </option>
                <option value="Lamborghini Huracan 2023">
            ...
            <img
              ...
              src="image/shadow_calc_pc.png"
              alt=""
            />
            <img
              class="calc__cars__mobile"
              src="image/shadow__mobile__form.png"
              alt=""
            />
          </div>
